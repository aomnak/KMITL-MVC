...
class WhiteCowView(QWidget):
    ...
    def init_ui(self):
        ...
        self.lemon_btn = QPushButton('ป้อนมะนาว')
        self.lemon_btn.clicked.connect(self.feed_lemon)
        layout.addWidget(self.lemon_btn)

        self.setLayout(layout)
        self.setWindowTitle('วัวสีขาว')
    ...
    def feed_lemon(self):
        self.cow.produce_milk(lemon=True)
        QMessageBox.information(self, "ป้อนมะนาว", "วัวผลิตนมเปรี้ยว!")
        
        # อัปเดตข้อมูลและแสดงรายงานการผลิตนมหลังจากป้อนมะนาวเสร็จ
        self.controller.save_cows()
        self.show_report()

    def show_report(self):
        # แสดงรายงานการผลิตนมทันทีหลังจากรีดนมเสร็จ
        self.report_view = CowReportView(self.controller)
